...
document.getElementById("Open").addEventListener("click", () => {
  const result = restaurants.filter((obj) => obj.restaurant_open_time);
  document.getElementById("root").innerHTML = "";
...
document.getElementById("Offers").addEventListener("click", () => {
  const result = restaurants.filter((obj) => obj.offers > 9);
  document.getElementById("root").innerHTML = "";

  getrestaurant(result);
});
document.getElementById("Filters").addEventListener("click", () => {
  document.getElementById("filterPopup").classList.remove("none");
});
document.getElementById("Filters").addEventListener("click", () => {
