...
//   const data = new set();
//   while (data.size != 5) {
//     const index = Math.floor(Math.floor() * 20);
//     data.add(questionBank[index]);
//   }
//   return [...data];
// }
// // slect the form and insrt all the element it
...
//   para.textContent = ` ${index + 1}. ${obj["questions"]}`;
...
//   });
//   FormData.appendChild(div_element);
// });
// const button = document.createElement("button");
// button.type = "submit";
// buton.className = "sunmit-btn";
...
form.addEventListener("submit", (event) => {
  ...
  for (let [key, value] of data.entries()) {
    if (value === correct_answer[key]) result++;
  }
