...
// const header1 = React.createElement('h1', { fontSize: "30px", backgroundColor: "pink", color: "white" }, "Hello Coder Army");
// const header2 = React.createElement('h2', { fontSize: "25px", backgroundColor: "black", color: "white" }, "Kaise ho aap sab log");

// const li1 = React.createElement('li', { color: "green" }, "HTML");
// const li2 = React.createElement('li', { color: "red" }, "CSS");
// const li3 = React.createElement('li', { color: "pink" }, "JS");
